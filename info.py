...
URL = "https://uhdmovietamil.onrender.com/".format(FQDN) if ON_HEROKU or NO_PORT else \
    "https://uhdmovietamil.onrender.com/".format(FQDN, PORT)
...
if HAS_SSL:
    URL = "https://uhdmovietamil.onrender.com/".format(FQDN)
else:
    URL = "https://uhdmovietamil.onrender.com/".format(FQDN)
